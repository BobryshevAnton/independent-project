...
},{"./sass/index.scss":"9OQSl","./js/search":"4TESp"}],"9OQSl":[function() {},{}],"4TESp":[function(require,module,exports) {
...
var _getLocalStorage = require("./get-localStorage");
var _getLocalStorageDefault = parcelHelpers.interopDefault(_getLocalStorage);
//
var _galleryPage = require("./gallery-page");
...
if (btnHome.classList.contains("current")) {
    ...
    anyText.textContent = "Search result not successful. Enter the correct movie name...";
    const searchApi = new (0, _searchApiDefault.default)();
    startPage();
    function handleSubmit(event) {
        ...
        if (searchFilm === "") {
            ...
            return;
        } else anyText.classList.add("hiden");
        createPage();
    }
    function createPage() {
        searchApi.getSearchMovie(searchFilm, page).then((data)=>{
            (0, _createGallery.createGallery)(data);
            page += 1;
        });
    }
    function startPage() {
...
} else (0, _getLocalStorageDefault.default)();
 //
 //
...
},{"./searchApi":"ho6Oh","./create-gallery":"g8kfr","./get-localStorage":"hJz9W","./gallery-page":"hXCsa","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ho6Oh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class SearchApi {
    ...
    async getMovies(page = this.page) {
        ...
        try {
            return await fetch(`${this.BASE_URL}${trending}/${mediaType}/${timeWindow}${this.API_KEY}&page=${page}`).then((res)=>res.json());
        } catch (arr) {
            console.log(arr);
        }
    }
    getSearchMovie(searchFilm, page) {
        try {
            return fetch(`${this.BASE_URL}search/movie${this.API_KEY}&query=${searchFilm}&page=${page}`).then((res)=>res.json());
        } catch (arr) {
            console.log(arr);
        }
    }
    async getGanres() {
        ...
        const list = "list";
        try {
            return await fetch(`${this.BASE_URL}${genre}/${option}/${list}${this.API_KEY}`).then((res)=>res.json());
        } catch (arr) {
            console.log(arr);
        }
    }
...
},{}],"g8kfr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createGallery", ()=>createGallery);
var _searchApi = require("./searchApi");
var _searchApiDefault = parcelHelpers.interopDefault(_searchApi);
var _createGanres = require("./create-ganres");
var _createGanresDefault = parcelHelpers.interopDefault(_createGanres);
var _modalFilm = require("./modal-film");
var _modalFilmDefault = parcelHelpers.interopDefault(_modalFilm);
const searchApi = new (0, _searchApiDefault.default)();
const indexGallery = document.querySelector(".gallery-container");
function createGallery({ results  }) {
    indexGallery.innerHTML = "";
    (0, _modalFilmDefault.default)({
        results
    });
    const markup = results.map(({ poster_path , title , release_date , vote_average , genre_ids  })=>{
        ...
        let ganresTitle = (0, _createGanresDefault.default)(genre_ids);
        if (!poster_path) baseImg = emptyImg;
        if (baseTitle.length > 25) baseTitle = baseTitle.slice(0, 30) + "...";
        else baseTitle;
        if (ganresTitle.length > 2) ganresTitle = ganresTitle.slice(0, 2).join(", ") + ", Other";
        else ganresTitle = ganresTitle.join(", ");
...
},{"./searchApi":"ho6Oh","./create-ganres":"2QnMc","./modal-film":"iex43","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2QnMc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _searchApi = require("./searchApi");
var _searchApiDefault = parcelHelpers.interopDefault(_searchApi);
...
function createGanres(genre_ids) {
    let curentGenres = [];
    ...
    genresNames.map((elem)=>{
        if (elem.length > 10) elem = elem.slice(0, 8) + "...";
        elem;
        newGenresNames.push(elem);
    });
    return newGenresNames;
}
exports.default = createGanres;

},{"./searchApi":"ho6Oh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iex43":[function(require,module,exports) {
// import SearchApi from './searchApi';
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _createGanres = require("./create-ganres");
var _createGanresDefault = parcelHelpers.interopDefault(_createGanres);
var _btnSearch = require("./btn-search");
var _btnSearchDefault = parcelHelpers.interopDefault(_btnSearch);
const indexGallery = document.querySelector(".gallery-container");
const backdropModal = document.querySelector(".backdrop");
const modal = document.querySelector("[data-modal]");
const btnClose = document.querySelector("[data-modal-close]");
const modalCont = document.querySelector(".modal-block");
function modalFilm({ results  }) {
    const filmMass = [
        ...results
    ];
    btnClose.addEventListener("click", handleBtnClose);
    function handleBtnClose(evt) {
        if (evt.currentTarget === evt.target) modal.classList.add("is-hidden");
    }
    ...
    function handleClick(evt) {
        ...
        filmMass.map((elem)=>{
            if (elem.original_title === evt.target.alt) {
                (0, _btnSearchDefault.default)(elem);
                let ganresTitle = (0, _createGanresDefault.default)(elem.genre_ids);
                if (ganresTitle.length > 2) ganresTitle = ganresTitle.slice(0, 2).join(", ") + ", Other";
                else ganresTitle = ganresTitle.join(", ");
    ...
    function onEscape(evt) {
        if (evt.code === "Escape") modal.classList.add("is-hidden");
    }
}
exports.default = modalFilm;

},{"./create-ganres":"2QnMc","./btn-search":"eYvPC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eYvPC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function btnSearch(elem) {
    elementFilmModal = elem;
    storageJsonWatch.map((storageWatch)=>{
        storageWatch.map((storElem)=>{
            if (storElem.title === elementFilmModal.title) addToWatch.textContent = "Added";
            else addToWatch.textContent = "add to Watched";
        });
    });
    ...
    function handleraddToWatch(evt) {
        ...
        } else if (localStorage.length !== 0 & !libryaryWatched.includes(elementFilmModal)) {
            libryaryWatched.push(elementFilmModal);
            localStorage.setItem(ADD_WATCH, JSON.stringify(libryaryWatched));
        }
    ...
    function handleraddToQueue(evt) {
        if (libruaryQueue.includes(elementFilmModal)) return;
        else {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hJz9W":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _galleryPage = require("./gallery-page");
var _galleryPageDefault = parcelHelpers.interopDefault(_galleryPage);
...
function getLocalStorage() {
    ...
    (0, _galleryPageDefault.default)(storageJsonWatch);
    const btnWatched = document.querySelector(".btn-Watched");
    btnWatched.classList.add("active");
    ...
    function handlerBtnQueue(evt) {
        ...
        (0, _galleryPageDefault.default)(storageJsonQueue);
...
},{"./gallery-page":"hXCsa","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hXCsa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _modalLibr = require("./modal-libr");
var _modalLibrDefault = parcelHelpers.interopDefault(_modalLibr);
const galleryConteiner = document.querySelector(".libruary-conteiner");
function galleryPage(filmArr) {
    galleryConteiner.innerHTML = "";
    (0, _modalLibrDefault.default)(filmArr);
    const markupStorage = filmArr.map(({ poster_path , title , release_date , vote_average , genre_ids  })=>{
        let emptyImg = "https://i.ibb.co/JyBCdzw/sinema-empty.jpg";
        let baseImg = `https://image.tmdb.org/t/p/w500${poster_path}`;
        let baseTitle = `${title}`;
        const baseDate = `${release_date.slice(0, 4)}`;
...
},{"./modal-libr":"dhNZU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dhNZU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _createGanres = require("./create-ganres");
var _createGanresDefault = parcelHelpers.interopDefault(_createGanres);
...
exports.default = modalLibr;

},{"./create-ganres":"2QnMc","./btn-search":"eYvPC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire993f")
